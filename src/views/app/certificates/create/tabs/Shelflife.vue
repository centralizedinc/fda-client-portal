      ...
      <v-card-text>
        <v-container grid-list-md>
          <v-layout row wrap align-center justify-center>
            ...
            <v-flex xs4>
              <v-select outline label="Type" :items="items" v-model="value" autocomplete></v-select>
            </v-flex>
            <v-flex xs4>
              <v-text-field
                outline
            ...
            <v-flex xs4>
              <span>shelf.date placed here</span>
              <v-text-field outline label="Open Date Marking/ Expiry Date" v-model="form.shelf.date"></v-text-field>
            </v-flex>
          </v-layout>
        </v-container>
      </v-card-text>
