          ...
          <template v-for="(item, index) in activities">
            ...
            <v-list-tile :key="index">
              ...
              <v-list-tile-content>
                ...
                <v-list-tile-sub-title>{{getAdminName(item.assigned_user).username}} {{getActStatus(item.status)}} {{getAppType(details.license_details.application_type)}} application of {{getCaseType(details.case_details.case_type)}} with</v-list-tile-sub-title>
