                                        ...
                                        <v-card-text>
                                            ...
                                            <v-card flat v-show="n===2">
                                                ...
                                                <v-card-title>
                                                    ...
                                                    <v-container grid-list-md text-xs-left v-for="(item, index) in form.estab_details.products" :key="index">
                                                        <v-layout row wrap>
                                                ...
                                                <v-card-title>
                                                    ...
                                                    <v-container grid-list-md text-xs-left>
                                                        <v-layout row wrap>
                                                            ...
                                                            <v-flex xs8>{{form.addresses.office.address + " " + form.addresses.office.region + " " + form.addresses.office.province + " " + form.addresses.office.city + " " + form.addresses.office.zipcode}}</v-flex>
                                                        </v-layout>
                                                    </v-container>
                                                </v-card-title>
                                                <v-card-title>
                                                    ...
                                                    <v-container grid-list-md text-xs-left>
                                                        <v-layout row wrap>
                                                            ...
                                                            <v-flex xs8>{{form.auth_officer.lastname + ", " + form.auth_officer.firstname + " " + form.auth_officer.middlename }}</v-flex>
                                                            ...
                                                            <v-flex xs8>{{form.auth_officer.id_type + " " + form.auth_officer.id_number }}</v-flex>
                                                            <v-flex xs4 class="fontbold">Address</v-flex>
                                                            <v-flex xs8>{{form.auth_officer.mail_add.address + " " + form.auth_officer.mail_add.region + " " + form.auth_officer.mail_add.province + " " + form.auth_officer.mail_add.city + " " + form.auth_officer.mail_add.zipcode}}</v-flex>
                                                ...
                                                <v-container grid-list-md text-xs-left v-for="(item, index) in form.qualified_personnel" :key="index">
                                                    <!-- <v-data-table
                                                        headers="headers"
                                                        items="items"
                                                        hide-actions
                                                ...
                                                <md-table-row slot="md-table-row" slot-scope="{ item }">
                                                    ...
                                                    <md-table-cell md-label="Birthdate" md-sort-by="birthdate">{{ item.birthdate }}</md-table-cell>
                                                    <md-table-cell md-label="TIN" md-sort-by="tin">{{ item.tin }}</md-table-cell>
                                                    <md-table-cell md-label="Government ID" md-sort-by="id">{{ item.id_type}}</md-table-cell>
