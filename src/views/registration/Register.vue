        ...
        <v-tab-item>
          <v-stepper v-model="e1" vertical>
            <v-stepper-step @click="proceed(1)" style="cursor:pointer" :complete="e1 > 1" step="1">
              ...
              >Enter the license number of your Establishment's LTO.</span>
            </v-stepper-step>
            <v-divider></v-divider>
            <v-stepper-step @click="proceed(2)" style="cursor:pointer" :complete="e1 > 2" step="2">
              ...
              <span
                class="caption font-weight-thin pa-1"
              >For single proprietorship reflect the name of the person indicated in the DTI registration certificate.</span>
              <span
                class="caption font-weight-thin pa-1"
              >For corporation, partnership or cooperative reflect the name of the corporation/partnership/cooperative as indicated in the SEC/CDA registration</span>
              <span
                class="caption font-weight-thin pa-1"
              >For government owned or controlled corporation reflect the name of the agency as indicated in the charter.</span>
            </v-stepper-step>
            <v-divider></v-divider>
            <v-stepper-step @click="proceed(3)" style="cursor:pointer" :complete="e1 > 3" step="3">
              ...
              <span
                class="caption font-weight-thin pa-1"
              >To make sure that we can still contact the establishment, please enter the company's qualified/authorized personnel</span>
            </v-stepper-step>
            <v-divider></v-divider>
            <v-stepper-step @click="proceed(4)" style="cursor:pointer" :complete="e1 > 4" step="4">
              ...
              <span
                class="caption font-weight-thin pa-1"
              >Please make sure that the ID number is matched to the ID selected</span>
            </v-stepper-step>
            <v-divider></v-divider>
...
export default {
  components: {
    ...
    step2: () => ({
      component: import("@/views/registration/tabs/EstablishmentInfo.vue")
    }),
