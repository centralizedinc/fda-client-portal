          ...
          <v-layout row wrap>
            <v-flex xs12 md4>
              <v-layout row wrap>
                ...
                <span
                  class="pt-5 mt-5 caption primary--text"
                >Note: For credit card transactions, an additional Php20.00 will be charged for convenience fee.</span>
              </v-layout>
            </v-flex>
            <v-flex xs1 pl-4>
      ...
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn
            ...
            :disabled="isLoading"
            @click.native="submitDialog=false"
          >Back</v-btn>
          <v-btn
            color="primary"
            :loading="isLoading"
